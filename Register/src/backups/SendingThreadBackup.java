...
//import server.ClientAndServer;
//import server.PostPackage;
...
//
//
//public class SendingThreadBackup implements Runnable {
//
//    private String port;
...
//
//    SendingThreadBackup(int port, ArrayList<String> httpText, String postData) {
